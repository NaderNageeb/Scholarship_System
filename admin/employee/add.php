                                ...
                                <div class="col-md-8">
                                  ...
                                  <div class="col-md-8"> -->
                                     ...
                                     <input class="form-control input-sm" id="BIRTHPLACE" name="BIRTHPLACE" placeholder=
                                        "Place of Birth" type="hidden" value="kh" required   autocomplete="off"></input>
                                  <!-- </div>
                                </div>
                              </div>  -->
                              ...
                              <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                   ...
                                   <input class="form-control input-sm" id="TELNO" name="TELNO" placeholder=
                                      "Contact No." type="number" any value="" required   autocomplete="off">
                                </div>
                              </div>
                            </div> 
                             ...
                             <!-- <div class="form-group">
                              <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                   ...
                                   <input type="hidden" class="form-control input-sm date_picker" value="<?php echo date("Y-m-d");  ?>" id="HIREDDATE" name="EMP_HIREDDATE" placeholder="mm/dd/yyyy"   autocomplete="false"/> 
