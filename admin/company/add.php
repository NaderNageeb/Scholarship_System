 ...
 <form class="form-horizontal span6" action="controller.php?action=add" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8"> -->
                        <input class="form-control input-sm" id="COMPANYADDRESS" name="COMPANYADDRESS" placeholder=
                            "Company Address" type="hidden"  required value="UNI" onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "COMPANYCONTACTNO">faculty Contact No.:</label>

                      <div class="col-md-8">
                         <input class="form-control input-sm" id="COMPANYCONTACTNO" name="COMPANYCONTACTNO" placeholder=
                            "faculty Contact No." type="text" value="" autocomplete="none">
                      </div>
                    </div>
                  </div>  
