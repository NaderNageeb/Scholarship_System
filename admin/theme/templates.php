  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu"> 
        ...
        <li class="<?php echo (currentpage() == 'Faculties') ? "active" : false;?>" >
          <a href="<?php echo web_root ;?>admin/company/">
            <i class="fa fa-building"></i> <span>Faculties</span> 
          </a>
        </li>
        <li class="<?php echo (currentpage() == 'Scholarships') ? "active" : false;?>" >
          <a href="<?php echo web_root ;?>admin/vacancy/">
            <i class="fa fa-suitcase"></i> <span>Scholarships</span> 
          </a>
        </li>
        ...
        <li class="<?php echo (currentpage() == 'Students') ? "active" : false;?>" > 
          <a href="<?php echo web_root ;?>admin/applicants/">
            <i class="fa fa-users"></i> <span>Applied Students</span> 
